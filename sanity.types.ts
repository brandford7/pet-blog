...
// Query: *[_type == "post" && defined(slug.current)] | order(date desc, _updatedAt desc) {    _id,    _type,    _createdAt,    _updatedAt,    title,    slug,    excerpt,    coverImage,    date,    author->,    categories[]->  }
